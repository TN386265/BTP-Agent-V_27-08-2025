CLASS /zuora001/je_validation DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
    ...
    METHODS value_mapping_transform
      CHANGING REFERENCE(is_header_check) TYPE  /zuora001/t_je_h
...
CLASS /ZUORA001/JE_VALIDATION IMPLEMENTATION.


  METHOD validate_header.
    CLEAR:ls_ret,gv_customer_id,gv_destination_name .
    IF is_header_check-comp_code IS INITIAL.
      ls_ret-res_id  = 'RW'.
      ls_ret-res_number  = '100'.
      ls_ret-type  = 'E'.
      ls_ret-message =  TEXT-001. "'Please enter a company code'.
    ...
    IF is_header_check-doc_type IS INITIAL.
      ls_ret-res_id  = 'RW'.
      ls_ret-res_number  = '103'.
      ls_ret-type  = 'E'.
      ls_ret-message = TEXT-007.
      APPEND ls_ret TO gt_invoice_ret.
      CLEAR ls_ret.
    ENDIF.
    ...
    " Validate DocDate
    IF is_header_check-doc_date IS INITIAL.
      ls_ret-res_id  = 'RW'.
      ls_ret-res_number  = '105'.
      ls_ret-type  = 'E'.
      ls_ret-message = TEXT-009.
      APPEND ls_ret TO gt_invoice_ret.
      CLEAR ls_ret.
    ENDIF.
...
*&----------------------------------------------------------------------------------------------->
    ...
    FIELD-SYMBOLS : <fs_head> TYPE /zuora001/t_je_h.
